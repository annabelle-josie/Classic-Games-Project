    ...
    for line in range (len(bricks)):
        for brick in range (len(bricks[line])):
            if (bricks[line][brick] == "."):
                ...
                rect_rb = (((1280 / 11 +10)*brick + 20)+100,  (55*line + 50) + 50)
                ...
                #
                #pygame.draw.rect(screen, "white", (((screen.get_width() / 11 +10)*brick + 20), (55*line + 50), 100, 50))
...
def reset():
    #global bricks, player_x, player_y, ball_x, ball_y, x_change, y_change, gameOver, won
    bricks = [[".", ".", ".", ".", ".", ".", ".", ".", ".", "."],[".", ".", ".", ".", ".", ".", ".", ".", ".", "."],[".", ".", ".", ".", ".", ".", ".", ".", ".", "."]]
    ...
    return(bricks, player_x, player_y, ball_x, ball_y, x_change, y_change, gameOver, won)
...
def gameLoop():
    ...
    while running:
        ...
        if (gameOver):
            ...
            if keys[pygame.K_r]:
                bricks, player_x, player_y, ball_x, ball_y, x_change, y_change, gameOver, won = reset()
        elif(won):
            screen.fill("pink")
            ...
            for line in range (len(bricks)):
                #pygame.draw.rect(screen, "white", (10,10, 70, 20))
                for brick in range (len(bricks[line])):
                    if (bricks[line][brick] == "."):
                        pygame.draw.rect(screen, "white", (((1280 / 11 +10)*brick + 20), (55*line + 50), 100, 50))
